# Generated by Django 2.1 on 2019-08-16 08:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('index', models.IntegerField(default=0, verbose_name='论播顺序')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('goods_sn', models.CharField(max_length=50, unique=True, verbose_name='商品唯一编号')),
                ('name', models.CharField(max_length=30, verbose_name='商品名称')),
                ('click_num', models.IntegerField(default=0, verbose_name='点击数')),
                ('sold_num', models.IntegerField(default=0, verbose_name='售卖数量')),
                ('fav_num', models.IntegerField(default=0, verbose_name='收藏数')),
                ('goods_num', models.IntegerField(default=0, verbose_name='商品数量')),
                ('market_price', models.IntegerField(default=0, verbose_name='市场价')),
                ('shop_price', models.IntegerField(default=0, verbose_name='售价')),
                ('goods_brief', models.TextField(max_length=500, verbose_name='商品简短描述')),
                ('goods_desc', ckeditor.fields.RichTextField(verbose_name='商品描述')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.IntegerField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类目')], verbose_name='分类级别')),
                ('is_tab', models.BooleanField(default=False, verbose_name='是否导航栏')),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父目录')),
            ],
            options={
                'verbose_name': '商品分类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.CharField(default='', max_length=150, verbose_name='品牌描述')),
